...
public class MainActivity extends ActionBarActivity {
     ...
     */
    String SENDER_ID = "149731509406";
    TextView mDisplay;
    GoogleCloudMessaging gcm;
    Context context;

    EditText usernameEditText;
    TextView registrationRs;
    TextView pushMsg;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registrationRs = (TextView) findViewById(R.id.registrationRs);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        registrationRs.setText(registrationRs.getText() + ": SUCCESSFUL!");
                    }
                }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                registrationRs.setText("That didn't work!");
            }
        });
...
//        stringBuilder.append("http://pushegro-server-test.herokuapp.com/rest/register?username=");
        ...
        stringBuilder.append(usernameEditText.getText());
